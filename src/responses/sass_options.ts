...
export const hello = {
  friendly: ['Hello there <:WhyHello:586724104732672000>', 'Hello :wave:', 'Want to be my friend?', 'Feeling lonely?', 'Chaotic mail?', 'Do you have a surprise for me?', 'Can I take your !order?', 'You are valuable and worthy of love', "I'm shy, so you talk I'll listen", 'My dream is to one day be a bot for the actual Chaotic website.', 'smiles and nods'],
  silly: ["Let's talk.. IN CHAOTIC!", "I'm too Nicool for you :sunglasses:", 'WHO DARES DISTURB MY SLUMBER?!', "If you @ me again I'm putting your favorite card on the banlist", "You don't control me you M'arrillian wanna be!", "What's so im-Port-ent?", 'Hello, my name is Inicole Montoya, you killed my father, prepare to die', 'You can tag anyone you want actually, the whole server is me in disguise.', "Speak up; I can't hear you.", '¡Nicolé', '5 more minutes, dad!', "Bots can't talk silly", 'People always say @ Nicole and never how’s Nicole? :pensive:'],

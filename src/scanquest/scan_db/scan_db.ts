    ...
    constructor() {
        this.db = new loki(path.resolve(db_path, 'scanquest.db'), {
            ...
            autoloadCallback: () => {
                ...
                let usedcodes = this.db.getCollection("usedcodes") as Collection<UsedCode>;
                if (usedcodes === null) {
                ...
                let activescans = this.db.getCollection("activescans") as Collection<ActiveScan>;
                if (activescans === null) {
                ...
                if (servers === null) {
                    ...
                    if (this.servers.findOne({id: "135657678633566208"}) === null) {
                        this.servers.add({id: "135657678633566208", 

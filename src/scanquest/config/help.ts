...
Hi there! It looks like this is your first time scanning. This collection of cards is not related to recode. Different cards will spawn based on how active the server is. They can be scanned for the amount of time listed above them in <#${perim}>.
...
${''/* 'You can also trade with another person by typing \`!trade <@user>\` and following the prompts. */}
